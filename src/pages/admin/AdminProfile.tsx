...
const AdminProfile: React.FC = () => {
  ...
  // address section removed per request
  ...
  // address not used in admin profile view
      } else {
  ...
  if (isLoading) {
    return (
      <NewAdminLayout title="Profile Settings" subtitle="Manage your admin profile">
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-gradient-to-br from-red-500 to-orange-600 rounded-full flex items-center justify-center text-white text-xl font-bold">
