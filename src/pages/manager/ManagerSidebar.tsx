...
export function ManagerSidebar() {
  ...
  const getNavCls = ({ isActive }: { isActive: boolean }) =>
    `${isActive 
      ? "bg-gradient-to-r from-green-50 to-emerald-50 text-green-700 border-l-3 border-green-500 rounded-r-lg shadow-sm" 
  ...
  return (
    <Sidebar className="w-64 lg:w-72 bg-white border-r border-gray-200 shadow-sm flex-shrink-0">
      <SidebarHeader className="border-b border-gray-100 p-4 bg-gradient-to-r from-green-50 to-emerald-50">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <Badge className="bg-green-100 text-green-700 border border-green-200 text-xs font-medium mt-1">
      ...
      <SidebarFooter className="border-t border-gray-100 p-4 bg-gray-50">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48 bg-white border border-gray-200 shadow-lg rounded-lg">
            <DropdownMenuItem onClick={handleProfileClick} className="hover:bg-green-50 rounded-md cursor-pointer">
              <User className="w-4 h-4 mr-2 text-green-600" />
              Profile
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => navigate("/manager/notifications")} className="hover:bg-emerald-50 rounded-md cursor-pointer">
