...
export default function ManagerDashboard() {
  ...
  const recentActivities = [
    {
      type: "appointment",
      message: "New appointment scheduled with Alex Thompson",
      time: "5 min ago",
      icon: Calendar,
    },
    {
      type: "user",
      message: "User profile updated: Jennifer Lee",
      time: "12 min ago",
      icon: Users,
    },
    {
      type: "service",
      message: "Service pricing updated: Premium Consultation",
      time: "1 hour ago",
      icon: Building2,
    },
    {
      type: "ticket",
      message: "Support ticket resolved: #ST-2024-001",
      time: "2 hours ago",
      icon: Ticket,
    },
  ];
          ...
          <div className="p-4 sm:p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {stats.map((stat, index) => (
                <Card
                  key={index}
                  className="border-0 bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl overflow-hidden"
                >
                    ...
                    <div className="space-y-4">
                      {todayAppointments.map((appointment) => {
                        ...
                        return (
                          <div
                            key={appointment.id}
                            className="bg-white rounded-xl border border-gray-100 hover:shadow-lg transition-all duration-200 overflow-hidden"
                          >
                            {/* Mobile Layout */}
                              ...
                              <div className="flex items-center gap-4 flex-1">
                                ...
                                <div className="flex-1">
                                  <div className="flex items-center gap-3 mb-1">
                                    ...
                                    <Badge
                                      className={`${statusConfig.bg} ${statusConfig.text} ${statusConfig.border} border text-xs`}
                                    >
                                      <StatusIcon className="w-3 h-3 mr-1" />
                                      {appointment.status}
                                    </Badge>
